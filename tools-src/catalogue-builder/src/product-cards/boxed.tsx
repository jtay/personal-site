...
export const BoxedProductCard: React.FC<ProductCardProps> = ({ product, theme, imageOverlay, belowImage }) => (
  <div
    style={{
      border: `1px solid ${theme.colorSecondary}33`,
  ...
  >
    <div style={{ position: 'relative', aspectRatio: '1 / 1', overflow: 'hidden', borderRadius: theme.borderRadius, background: '#f2f2f2' }}>
